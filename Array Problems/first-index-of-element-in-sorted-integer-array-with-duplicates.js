 ...
 */
{
   ...
   * Returns the first index of the num in the array, if num is not present,
   * this returns -1
   * @param {Array} arr input sorted array
   * @param {number} num to be searched
   * @returns {number} first index of the num in the array
  ...
  function searchElementAndReturnFirstIndex(arr = [], num) {
    ...
    // after the index is found looping through the array untill the next lesser element
  ...
  searchElementAndReturnFirstIndex([0, 1, 2, 2, 4, 5, 5, 5, 5], 0);
}
